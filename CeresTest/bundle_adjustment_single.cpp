...
//#define GIVE_NOISE_ON_WORLD_POINTS
...
#ifdef GIVE_NOISE_ON_WORLD_POINTS
		srand(time(NULL));
#endif
...
#else
					world_points[(frame_idx*NUM_CAMERA*NUM_POINTS * 3) + (cam_idx * NUM_POINTS * 3) + (p_idx * 3) + 0] = X;
					world_points[(frame_idx*NUM_CAMERA*NUM_POINTS * 3) + (cam_idx * NUM_POINTS * 3) + (p_idx * 3) + 1] = Y;
					world_points[(frame_idx*NUM_CAMERA*NUM_POINTS * 3) + (cam_idx * NUM_POINTS * 3) + (p_idx * 3) + 2] = Z
						;
#endif
				}
			}
